...
export class MedicalAppointement {
  ...
  @ManyToOne(() => User, (user) => user.medicalAppointements, {
    eager: true,
    onDelete: 'CASCADE',
  })
  user: User;

  @ManyToOne(() => Pregnancy, (pregnancy) => pregnancy.medicalAppointments, {
    nullable: true,
  })
  pregnancy?: Pregnancy;
  ...
  @ManyToOne(
    () => AppointementType,
    (appointementType) => appointementType.medicalAppointements,
  )
